...
//斜边折叠view
class CustomCameraAnimatorView(context: Context, attributeSet: AttributeSet) :
...
//        rotate(cameraRotateDegrees, 0f, 0f)
...
//            }
            camera.save()
            camera.rotate(cameraRotateDegrees, 0f, 0f)
